...
/obj/item/proc/attack(mob/living/M, mob/living/user, var/target_zone)
	...
	if(!no_attack_log)
		admin_attack_log(user, M, "Attacked using \a [src] (DAMTYE: [ruppertext(damtype)])", "Was attacked with \a [src] (DAMTYE: [ruppertext(damtype)])", "used \a [src] (DAMTYE: [ruppertext(damtype)]) to attack")
	/////////////////////////
