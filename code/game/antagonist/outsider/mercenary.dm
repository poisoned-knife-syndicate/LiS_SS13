...
/datum/antagonist/mercenary
	id = MODE_MERCENARY
	role_text = "Syndicate Force"
	antag_indicator = "hudsyndicate"
	role_text_plural = "Syndicate Force`s"
	landmark_id = "Syndicate-Spawn"
	leader_welcome_text = "You are the leader of the Syndicate Force`s strikeforce; hail to the chief. Use :t to speak to your underlings."
