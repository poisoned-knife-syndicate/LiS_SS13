	...
	for(var/mob/living/silicon/ai/M in GLOB.living_mob_list_)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			switch(rand(1,14))
				if(1)
					to_chat(M, "<br>")
					to_chat(M, "<span class='danger'>THERE ARE [amount] [who2] ON THE [ruppertext(station_name())]...LAWS UPDATED</span>")
					to_chat(M, "<br>")
					M.add_ion_law("THERE ARE [amount] [who2] ON THE [ruppertext(station_name())]")
				if(2)
					to_chat(M, "<br>")
				...
				if(3)
					to_chat(M, "<br>")
					to_chat(M, "<span class='danger'>THE ESCAPE-SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE [ruppertext(station_name())]...LAWS UPDATED</span>")
					to_chat(M, "<br>")
					M.add_ion_law("THE ESCAPE SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE [ruppertext(station_name())]")
				if(4)
					to_chat(M, "<br>")
				...
				if(6)
					to_chat(M, "<br>")
					to_chat(M, "<span class='danger'>THE [ruppertext(station_name())] IS BUILT FOR [who2]...LAWS UPDATED</span>")
					to_chat(M, "<br>")
					M.add_ion_law("THE [ruppertext(station_name())] IS BUILT FOR [who2]")
				if(7)
					to_chat(M, "<br>")
				...
				if(14)
					to_chat(M, "<br>")
					to_chat(M, "<span class='danger'>THE [ruppertext(station_name())] IS [who2pref] [who2]...LAWS UPDATED</span>")
					to_chat(M, "<br>")
					M.add_ion_law("THE [ruppertext(station_name())] IS [who2pref] [who2]")
